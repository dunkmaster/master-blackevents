...
namespace constants
{
	...
	//Main
	const int SIMULATION_TOTAL_TIME = 50300000;//SC_NS std:10 000
	const int TIME_WINDOW = 1000; //us
	const char OUTPUT_FILE_NAME[] = "abc.txt";
	const char MAPPING_FILE[] = "Mapping.csv";

	//Data Generator
	const int NUMBER_TIME_WINDOWS_TO_SIMULATE = 300;
	...
	const int DG_SIMULTION_TYPE = 5; // 1 = standard, 2 = incremental occupancy!, 3 = global randomness, 4 = black events, 5 =
