...
namespace constants
{
	...
	const int DG_SIMULTION_TYPE = 4; // 1 = standard, 2 = incremental occupancy!, 3 = global randomness

	//CRU
	const int CRU_WAIT_TIME = 5;	//2 ns (clock cycles) for 500MHz
	const int CRU_NUMBER_INPUT_PORTS = 2 * NUMBER_OF_FECS; //24 gbt per 1 CRU
	...
	const int NUMBER_OF_GBT_CHIPS = 2 * NUMBER_OF_FECS * NUMBER_OF_CRU_CHIPS;//2 for 1 FEC; 24 for 12 FEC
	...
	const int NUMBER_OF_SAMPA_CHIPS = 5 * NUMBER_OF_FECS * NUMBER_OF_CRU_CHIPS;//5 for 1 FEC; 60 for 12 FEC
